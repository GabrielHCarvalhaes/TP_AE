...
class Show{
    ...
    public static void leiaShow(Show[] show) throws IOException, ParseException{
        ...
        RandomAccessFile file = new RandomAccessFile("./tmp/disneyplus.csv", "r");
        ...
        while((linha = file.readLine()) != null){
            ...
            String[]cast = divisao[4].split("\\s*,\\s*");// Remove espaços ao redor das vírgulas
            ordenandoVetor(cast);
            ...
            String[] listed = divisao[10].split("\\s*,\\s*"); 
            ordenandoVetor(cast);

            show[index] = new Show(divisao[0], divisao[1], divisao[2], divisao[3], cast,
    ...
    public void imprimir(){
        ...
        System.out.print("=> " + show_id + " ## " + type + " ## " + title + " ## " );
